  ...
  return self = {
    ...
    calculateZoomToOrigin: function (element, originator) {
      ...
      if (origin || bounds) {
        ...
        var dialogCenterPt = self.centerPointFor(dialogRect || blankElement);
        var originCenterPt = self.centerPointFor(originBnds || blankElement);
  ...
  function keydown (event) {
    switch (event.keyCode) {
      ...
      case $mdConstant.KEY_CODE.TAB:
        ...
        break;
      case $mdConstant.KEY_CODE.ENTER:
        if (ctrl.hidden && !ctrl.loading) return;
...
function MdAutocomplete () {
  ...
  return {
    ...
    link: function(scope, element, attrs, controller) {
      controller.hasNotFound = !!attrs.hasNotFoundTemplate;
    },
